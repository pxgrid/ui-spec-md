	...
	_createClass(Editor, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(EditorToolbar, this.state),
				React.createElement(EditorViewport, this.state)
			);
		}
	}]);
...
},{"../store.js":178,"./EditorToolbar.jsx":169,"./EditorViewport.jsx":175,"react":165}],167:[function(require,module,exports){
'use strict';
...
var EditorCanvas = function (_React$Component) {
	...
	function EditorCanvas() {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorCanvas).apply(this, arguments));
	}
...
},{"../store.js":178,"./Highlight.jsx":176,"react":165}],168:[function(require,module,exports){
'use strict';
...
var EditorDrop = function (_React$Component) {
	...
	function EditorDrop() {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorDrop).apply(this, arguments));
	}
...
},{"../store.js":178,"react":165}],169:[function(require,module,exports){
'use strict';
	...
	return React.createElement(
		...
		React.createElement(
			...
			React.createElement(
				...
				React.createElement(ItemOrderControl, { selectedItem: selectedItem }),
				...
				React.createElement(ItemRemoveControl, null),
				React.createElement(ItemZoomControl, null)
			)
		)
	);
};
...
},{"./EditorToolbar/ItemCoordsControl.jsx":170,"./EditorToolbar/ItemOrderControl.jsx":171,"./EditorToolbar/ItemRemoveControl.jsx":172,"./EditorToolbar/ItemSrcControl.jsx":173,"./EditorToolbar/ItemZoomControl.jsx":174,"react":165}],170:[function(require,module,exports){
'use strict';
...
var ItemCoordsControl = function (_React$Component) {
	...
	function ItemCoordsControl() {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ItemCoordsControl).call(this));
	...
	_createClass(ItemCoordsControl, [{
		...
		value: function componentWillReceiveProps(nextProps) {
			...
			var val = typeof selectedItem === 'number' ? coords[selectedItem][LOOKUP[target]] : undefined;
...
},{"../../store":178,"react":165}],171:[function(require,module,exports){
'use strict';
...
},{"../../store":178,"react":165}],172:[function(require,module,exports){
'use strict';

var React = require('react');
var store = require('../../store');

var ItemOrderControl = function ItemOrderControl() {
...
},{"../../store":178,"react":165}],173:[function(require,module,exports){
"use strict";
...
var ItemSrcControl = function (_React$Component) {
	...
	function ItemSrcControl() {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(ItemSrcControl).apply(this, arguments));
	}
...
var ItemZoomControl = function ItemZoomControl() {
	return React.createElement(
		'div',
		{ className: 'EDT-EditorToolbar__item' },
		React.createElement(
...
},{"../../store":178,"react":165}],175:[function(require,module,exports){
'use strict';
...
var EditorViewport = function (_React$Component) {
	...
	function EditorViewport() {
		...
		return _possibleConstructorReturn(this, Object.getPrototypeOf(EditorViewport).apply(this, arguments));
	}
	...
	_createClass(EditorViewport, [{
		...
		value: function render() {
			...
			if (!!this.props.src) {
				...
				El = React.createElement(EditorDrop, null);
			}
...
},{"./EditorCanvas.jsx":167,"./EditorDrop.jsx":168,"react":165}],176:[function(require,module,exports){
'use strict';
...
var Highlight = function (_React$Component) {
	...
	function Highlight() {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Highlight).call(this));
	...
	_createClass(Highlight, [{
				...
				'g',
				{
					...
					onMouseDown: function onMouseDown() {
						...
						store.dispatch({
							...
							selectedItem: _this2.props.order
						});
					}
				},
		...
		value: function _handleDrag(e) {
			...
			var draggingEl = _state.draggingEl;
			var dragStartOffsetX = _state.dragStartOffsetX;
			var dragStartOffsetY = _state.dragStartOffsetY;
			var _props2 = this.props;
			var getCoordByXY = _props2.getCoordByXY;
...
},{"../store.js":178,"react":165}],177:[function(require,module,exports){
'use strict';
...
},{"./component/Editor.jsx":166,"./store":178,"react":165,"react-dom":29}],178:[function(require,module,exports){
'use strict';

var createStore = require('./util/createStore.js');
var MINIMUM_SIZE = 20;
...
},{"./util/createStore.js":179}],179:[function(require,module,exports){
"use strict";
