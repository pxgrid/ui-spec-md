...
},{"../store.js":180}],167:[function(require,module,exports){
'use strict';
...
},{"../store.js":180}],168:[function(require,module,exports){
'use strict';
...
},{"../action/Editor":166,"../action/Highlight":167,"../store.js":180,"./EditorToolbar.jsx":169,"./EditorViewport.jsx":175,"react":165}],169:[function(require,module,exports){
'use strict';
...
var EditorToolbar = function EditorToolbar(props) {
	...
	var shiftAction = props.shiftAction;
	var unshiftAction = props.unshiftAction;
	var coordsAction = props.coordsAction;
...
var ItemCoordsControl = function (_React$Component) {
	...
	_createClass(ItemCoordsControl, [{
		...
		value: function onChange(e) {
			...
			var coordsAction = _props.coordsAction;
...
},{"./EditorViewport/EditorCanvas.jsx":176,"./EditorViewport/EditorDrop.jsx":177,"react":165}],176:[function(require,module,exports){
'use strict';
...
var EditorCanvas = function (_React$Component) {
	...
	_createClass(EditorCanvas, [{
		...
		value: function render() {
			...
			var selectedItem = _props.selectedItem;
			var coordsAction = _props.coordsAction;
			var selectHighlightAction = _props.selectHighlightAction;
...
},{"./Highlight.jsx":178,"react":165}],177:[function(require,module,exports){
'use strict';
...
var EditorDrop = function (_React$Component) {
	...
	function EditorDrop() {
		...
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(EditorDrop).call(this));
...
var Highlight = function (_React$Component) {
	...
	_createClass(Highlight, [{
		...
		value: function _handleDrag(e) {
			...
			var coord = _props2.coord;
			var order = _props2.order;
			var coordsAction = _props2.coordsAction;
...
var src = _parseInitUrl.src;
var highlight = _parseInitUrl.highlight;

EditorAction.initAction(src, highlight);

ReactDOM.render(React.createElement(Editor, null), document.getElementById('app'));

},{"./action/Editor":166,"./component/Editor.jsx":168,"./util/parseInitUrl":182,"react":165,"react-dom":29}],180:[function(require,module,exports){
'use strict';
...
},{"./util/createStore":181}],181:[function(require,module,exports){
"use strict";
