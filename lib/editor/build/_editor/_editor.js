...
var Editor = function (_React$Component) {
	...
	function Editor(props, context) {
		...
		_this.state = Object.assign({}, _this.props.store.getState());
...
var EditorToolbar = function (_React$Component2) {
	_inherits(EditorToolbar, _React$Component2);
...
var Highlight = function (_React$Component3) {
...
var EditorViewport = function (_React$Component4) {
	_inherits(EditorViewport, _React$Component4);
	...
	_createClass(EditorViewport, [{
		...
		value: function render() {
			...
			var coords = _props4.coords;
			var selectedItem = _props4.selectedItem;
...
var EditorCanvas = function (_React$Component5) {
	_inherits(EditorCanvas, _React$Component5);
	...
	_createClass(EditorCanvas, [{
		...
		value: function render() {
			...
			var coords = _props5.coords;
			var selectedItem = _props5.selectedItem;
...
var EditorDrop = function (_React$Component6) {
	_inherits(EditorDrop, _React$Component6);
...
// main
ReactDOM.render(React.createElement(Editor, { store: store }), document.body);

},{"./store.js":3}],3:[function(require,module,exports){
'use strict';
